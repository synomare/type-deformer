(function(root){
  ...
  function create(options){
    ...
    function stopWorker(){clearInterrupt();if(worker)worker.terminate();worker=null;knownFonts.clear();}
    ...
    function launch(job){
      ...
      }catch(error){active=null;failure={key:job.key,message:error.message};notify();}
    }
    ...
    function cancel(){stopWorker();active=waiting=desired=null;failure=null;notify();}
